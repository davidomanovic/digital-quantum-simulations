...
<p align="center">
  ...
  <img src="output/correlators2.png" alt="Correlation functions between spin" width="30%">
  <img src="output/3qubitfidelity.png" alt="Image 3" width="30%">
</p>

Project in Quantum computing for spin models. We wish to simulate dynamics of physical systems using quantum circuits, which is done by digital quantum simulation of interacting spin models with IBMQ.
